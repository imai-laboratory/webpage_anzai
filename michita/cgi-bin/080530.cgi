...
#
{
	...
	print "\n";
	print "$header\n";
	print "資料は二つあります。それぞれ情報処理同実習のフォルダに保存。\n";
	print "<ul>\n";
	print "<li><a href=\"http://www.ayu.ics.keio.ac.jp/~michita/Joho2008/080530.xls\">その１</a>\n";
	print "<li><a href=\"http://www.ayu.ics.keio.ac.jp/~michita/Joho2008/080530-kadai.xls\">その２</a>\n";
	print "</ul>\n";
#	print "$mail\n";
	print "$footer\n";
}
