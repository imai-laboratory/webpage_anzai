...
#
{
	...
	if ($room == 0){
	    print "<font color=\"#ff0000\">641教室外部</font>からの参加はできません。 \n";
	    print " \n";
	}

	if ($room == 1){
	    print "問題を情報処理同実習のフォルダに保存。\n";
	    print "<ul>\n";
	    print "<li><a href=\"http://www.ayu.ics.keio.ac.jp/~michita/Joho2008/shiken080704.pdf\">問題</a>\n";
	    print "</ul>\n";
	}
#	print "$mail\n";
	print "$footer\n";
