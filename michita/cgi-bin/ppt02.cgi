...
#check flag for room number
$room = 0;

{

	@ipadd = split(/\./,$ENV{'REMOTE_ADDR'});
	...
	if($room == 0){
	    $mailbody .= "WARNING!! ***** This submission came from the outside of room 641.***********\n";
	}
...
#
{
	...
	if ($room == 0){
	    print "<font color=\"#ff0000\">641教室外部</font>からの登録は出席にはなりません。 \n";
	    print " \n";
	}
	print "資料を情報処理同実習のフォルダに保存。\n";
	print "<ul>\n";
	print "<li><a href=\"http://www.ayu.ics.keio.ac.jp/~michita/Joho2008/080620-dist.ppt\">その１</a>\n";
	print "</ul>\n";
#	print "$mail\n";
	print "$footer\n";
}
